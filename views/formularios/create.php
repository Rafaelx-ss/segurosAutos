	...
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
        	<div class="page-title-icon">
            	<i class="pe-7s-browsericon-gradient bg-malibu-beach"></i>
            </div>
            <div>
				Formularios				<div class="page-title-subheading">Alta de registro</div>
            </div>
        </div>
...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
	...
	<li class="nav-item">
		<?php
		echo Html::a('<span><i class="'.$iAdd.'" aria-hidden="true"></i> Alta</span>', $url = ['formularios/create'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones().' active']);
		?>
    </li>
</ul>
