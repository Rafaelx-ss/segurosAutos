...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'metodosusuariosapis', 'Metodosusuariosapis', $frmSeguridad, 'update', '1', '&usuarioApiID='.$model->usuarioApiID.'&metodoApiID='.$model->metodoApiID);
