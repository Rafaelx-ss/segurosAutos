...
<div class="app-page-title">
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
            ...
            <div>
				Formularios perfiles				<div class="page-title-subheading">Alta de registro</div>
            </div>
        </div>
...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
	...
	<li class="nav-item">
		<?php
		echo Html::a('<span><i class="'.$iAdd.'" aria-hidden="true"></i> Alta</span>', $url = ['formulariosperfiles/create'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones().' active']);
		?>
    </li>
</ul>
