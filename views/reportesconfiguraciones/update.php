...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'reportesconfiguraciones', 'Reportesconfiguraciones', $frmSeguridad, 'update', '1', '&id='.$model->reporteConfiguracionID);
