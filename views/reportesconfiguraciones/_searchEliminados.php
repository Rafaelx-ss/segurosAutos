...
/* @var $model app\models\ReportesconfiguracionesSearch */
...
<div class="reportesconfiguraciones-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='ReportesConfiguraciones'")->queryOne();
