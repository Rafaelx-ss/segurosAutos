...
<div class="main-card mb-3 card">
	...
	?>
					...
					'summary' => Html::a('<i class="fa fa-minus-square" aria-hidden="true"></i> Limpiar filtro', $url = ['templatereporte/index&clear=true'], $options = ['style'=>'color:#003e59;']).' | Viendo {count} de {totalCount} resultados.', 
					...
					'columns' => [
						...
						['class' => 'yii\grid\CheckboxColumn', 'checkboxOptions' => function($data) {
							...
							'nombreTemplateReporte',
							'encabezadoTemplateReporte',
							'pieTemplateReporteL1',
							...
							'options' => ['style' => 'width:50px;'],
									...
									'buttons' => [
										...
										'delete' => function ($url, $model) {
											$url_group = 'javascript:confirmDelete('.$model->templateReporteID.')';
											return Html::a(
