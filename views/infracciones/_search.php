...
/* @var $model app\models\InfraccionesSearch */
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='Infracciones'")->queryOne();
