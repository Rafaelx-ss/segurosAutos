...
<div class="app-page-title">
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
            ...
            <div>
				Combos		<div class="page-title-subheading">Alta - <?php echo $catalogo['nombreCatalogo']; ?></div>
            </div>
        </div>
...
<div class="main-card mb-3 card">
      <div class="card-body">
					...
					<span style="font-size: 16px;">Ingresa los datos solicitados (Para que los cambios se vean en el formulario del catalogo, es requerido crear el crud)<br><br></span>	
					
					<?php 						
						echo $this->render('_form', [
							'model' => $model, 'catalogoID'=>$catalogo['catalogoID'],
						]); 
					?>
	</div>
</div>