...
<div class="col-sm-4 float-left pleft-0">    
	<?php 
		echo $form->field($model, 'campoIDPadre')->widget(Select2::classname(), [                         
			'data' => ArrayHelper::map(Campos::find()->andWhere(['=', 'regEstado', 1])->andWhere(['=', 'catalogoID', $catalogoID])->orderBy('nombreCampo')->all(), 'campoID', 'nombreCampo'),
			'language' => 'es',
...
<div class="col-12  pleft-0">
    <div class="form-group">
		...
		<?= $form->field($model, 'catalogoID')->textInput(['value'=>$catalogoID, 'type'=>'hidden'])->label(false) ?>
    </div>
</div>
