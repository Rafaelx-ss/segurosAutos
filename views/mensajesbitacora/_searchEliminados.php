...
/* @var $model app\models\MensajesbitacoraSearch */
...
<div class="mensajesbitacora-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='MensajesBitacora'")->queryOne();
