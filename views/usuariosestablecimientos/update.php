...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'usuariosestablecimientos', 'Usuariosestablecimientos', $frmSeguridad, 'update', '1', '&usuarioID='.$model->usuarioID.'&establecimientoID='.$model->establecimientoID);
