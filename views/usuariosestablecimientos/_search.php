...
/* @var $model app\models\UsuariosestablecimientosSearch */
...
<div class="usuariosestablecimientos-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='UsuariosEstablecimientos'")->queryOne();
