...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
	<li class="nav-item">
		<?php
		echo Html::a('<span><i class="fa fa-edit"></i> Editar Generales</span>', $url = ['reportespdf/update&f='.$idForm.'&id='.$model->reportesPdfID], $options = ['class'=>'mb-2 mr-2 btn-transition btn btn-outline-info']);
		?>
    </li>
	
	<li class="nav-item">
		<?php
		echo Html::a('<span><i class="lnr-file-empty"></i>  Encabezado PDF</span>', $url = ['reportespdf/header&f='.$idForm.'&id='.$model->reportesPdfID], $options = ['class'=>'mb-2 mr-2 btn btn-info']);
		?>
    </li>
	<li class="nav-item">
		<?php
