...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
	...
	<li class="nav-item">
		<?php
		echo Html::a('<span><i class="lnr-file-empty"></i> Contenido PDF</span>', $url = ['reportespdf/pdf&f='.$idForm.'&id='.$model->reportesPdfID], $options = ['class'=>'mb-2 mr-2 btn btn-info']);
		?>
    </li>
	<li class="nav-item">
		<?php
