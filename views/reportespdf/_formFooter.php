...
<div class="col-4 float-left  pleft-0">
	<?php
		echo $form->field($model, 'altoFooter')->textInput(['type'=>'number', 'required'=>'required'])->label();
	?>
</div>
...
<div class="col-4 float-left  pleft-0">
	...
	if($model->isNewRecord){
		echo $form->field($model, 'paginacionReporte')->checkbox(['checked'=>'checked']);
	}else{
		echo $form->field($model, 'paginacionReporte')->checkbox();
	}
	?>
</div>
