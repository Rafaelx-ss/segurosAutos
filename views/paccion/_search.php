...
/* @var $model app\models\PaccionSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="paccion-search">
    ...
    <?= $form->field($model, 'PerfilAccionFormularioID') ?>

    <?= $form->field($model, 'perfilID') ?>

    <?= $form->field($model, 'accionFormularioID') ?>

    <?= $form->field($model, 'activoPerfilAccionFormulario')->checkbox() ?>
