	...
	if(isset($_GET['insert'])){
		if($_GET['insert'] == 'true'){
			echo '<div class="alert alert-success" role="alert">
					 <i class="fa fa-check-square-o" aria-hidden="true"></i>  Registro guardado con exito! ('.Html::a("Ver perfil accion", $url = ['paccion/update&id='.$_GET['id']], $options = ['class'=>'']).')
				 </div>';
		}
	}
...
<div style="clear: both;"></div>
	...
	<div class="col-sm-4 float-left pleft-0">  
		<?php
			echo $form->field($model, 'accionFormularioID')->widget(Select2::classname(), [                         
				'data' => ArrayHelper::map(Aformularios::find()->andWhere(['=', 'regEstado', '1'])->orderBy('claveAccion')->all(), 'accionFormularioID', 'claveAccion'),
				'language' => 'es',
				'options' => ['placeholder' => ' --- Selecciona --- '],
				'pluginOptions' => ['allowClear' => true]]); 	
		?>
