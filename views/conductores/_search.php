...
/* @var $model app\models\ConductoresSearch */
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='Conductores'")->queryOne();
