...
<div class="main-card mb-3 card">
	...
	?>
     ...
     <?= GridView::widget([
					...
					'summary' => Html::a('<i class="fa fa-minus-square" aria-hidden="true"></i> Limpiar filtro', $url = ['apiconfiguraciones/index&clear=true'], $options = ['style'=>'color:#003e59;']).' | Viendo {count} de {totalCount} resultados.', 
					...
					'columns' => [
						...
						['class' => 'yii\grid\CheckboxColumn', 'checkboxOptions' => function($data) {
								...
								//'aplicacionID',
								[
									'attribute'=>'aplicacionID',
									'value'=> 'idAplicaciones.nombreAplicacion',
									'format' => 'raw',
								],
							...
							'options' => ['style' => 'width:50px;'],
									...
									'buttons' => [
										'update' => function ($url, $model) {
											$url_group = 'index.php?r=apiconfiguraciones/update&id='.$model->apiListaConfiguracionID;
											return Html::a(
										...
										'delete' => function ($url, $model) {
											$url_group = 'javascript:confirmDelete('.$model->apiListaConfiguracionID.')';
											return Html::a(
