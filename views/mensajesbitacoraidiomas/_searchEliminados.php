...
/* @var $model app\models\MensajesbitacoraidiomasSearch */
...
<div class="mensajesbitacoraidiomas-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='MensajesBitacoraIdiomas'")->queryOne();
