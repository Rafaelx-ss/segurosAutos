...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'mensajesbitacoraidiomas', 'Mensajesbitacoraidiomas', $frmSeguridad, 'update', '1', '&id='.$model->mensajeBitacoraIdiomasID);
