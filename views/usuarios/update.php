...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
    ...
    <li class="nav-item">
	 ...
	 <li class="nav-item">
		<?php
		echo  Html::a('<span><i class="fas fa-file-alt" aria-hidden="true"></i> &nbsp;Carta responsiva</span>', $url = ['usuarios/cartaresponsiva&id='.$_GET['id']], $options = ['class' => 'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones()]);
		?>
    </li>
</ul>
