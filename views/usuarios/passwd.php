...
<div class="app-page-title">
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
            ...
            <div>
				Usuarios 
				<div class="page-title-subheading">Editar Contraseña - <?= $model->nombreUsuario ?></div>
            </div>
        </div>
...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
    ...
    <li class="nav-item">
		<?php
		echo  Html::a('<span><i class="pe-7s-note" aria-hidden="true"></i> Editar</span>', $url = ['usuarios/update&id='.$_GET['id']], $options = ['class' => 'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones()]);
		?>
    </li>
</ul>
