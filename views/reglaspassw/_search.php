...
/* @var $model app\models\ReglaspasswSearch */
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='ReglasPassw'")->queryOne();
