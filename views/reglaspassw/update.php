...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'reglaspassw', 'Reglaspassw', $frmSeguridad, 'update', '1', '&minimioLongitudPassw='.$model->minimioLongitudPassw.'&maximoIntentosFallidos='.$model->maximoIntentosFallidos.'&tiempoCaducidadCodigoRecuperacionPassw='.$model->tiempoCaducidadCodigoRecuperacionPassw.'&tiempoCaducidadInactivadadPassw='.$model->tiempoCaducidadInactivadadPassw.'&contieneMayuscula='.$model->contieneMayuscula.'&contieneCaracteresEspeciales='.$model->contieneCaracteresEspeciales.'&contieneNumeros='.$model->contieneNumeros);
