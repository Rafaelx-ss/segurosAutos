...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'alertasconfiguracioncorreo', 'Alertasconfiguracioncorreo', $frmSeguridad, 'update', '1', '&id='.$model->alertaConfiguracionCorreoID);
