...
/* @var $model app\models\AlertasconfiguracioncorreoSearch */
...
<div class="alertasconfiguracioncorreo-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='AlertasConfiguracionCorreo'")->queryOne();
