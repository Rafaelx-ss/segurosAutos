...
<div class="app-page-title">
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
            ...
            <div>
				Catalogos				<div class="page-title-subheading">Generar CRUD</div>
            </div>
        </div>
			  				...
			  				if(isset($_POST['generar'])){
								...
								foreach($modelQry as $row){
									if(isset($_POST['model_'.$row['nombreModelo']])){
										echo $numMod.".- ";
										Yii::$app->globals->createCrud($row['nombreModelo']);
										$numMod = 1;
									}
									//break;
								}
							}else{
								echo "<br><strong style='font-size:18px;'>Modelos ( <input type='checkbox' checked id='select_all' /> seleccionar todos)</strong><br>";
								echo '<div class="form-group" style="margin-top: 1px; ">';
								$form = ActiveForm::begin([
											'id' => 'form',
											'action' => ['catalogos/crud'],
								...
								echo '</div>
											  <div class="form-group" style="margin-top: 1px; ">
													<button type="submit" class="btn btn-info " id="btn_export">Iniciar creación del CRUD</button>
											  </div>';
								ActiveForm::end();
							}
		  }
