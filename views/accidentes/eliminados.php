...
$perElimckh = false;
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'accidentes', 'Accidentes', $frmSeguridad, 'index', '1');

$perElimckh = $menuBotones['visible'];
echo $menuBotones['botones'];

if(Yii::$app->globals->getIndexSearch('Accidentes') != 0){
...
<div class="main-card mb-3 card">
	...
	?>
					...
					'summary' => Html::a('<i class="fa fa-minus-square" aria-hidden="true"></i> '.Yii::$app->globals->getTraductor(5, Yii::$app->session['idiomaId'], 'Limpiar filtros'), $url = ['accidentes/eliminados&f='.$idForm.'&clear=true'], $options = ['style'=>'color:#003e59;']).' | Viendo {count} de {totalCount} resultados.', 
					'filterModel' => $searchModel,       
					'columns' => [
						['class' => 'yii\grid\SerialColumn'],
		  						  				['class' => 'yii\grid\CheckboxColumn', 'checkboxOptions' => function($data) {
										return ['value' => $data->accidenteID];
								}, 'visible' => $perElimckh,
						],
		  						  				
						['attribute' => 'accidenteID','label' => Yii::$app->globals->getTraductor('1', Yii::$app->session['idiomaId'], 'accidenteID'),'value' => 'accidenteID','format'=> 'raw'],
['attribute' => 'polizaID','label' => Yii::$app->globals->getTraductor('721', Yii::$app->session['idiomaId'], 'polizaID'),'value' => 'idPolizas.numeroPoliza','format'=> 'raw'],
['attribute' => 'vehiculoID','label' => Yii::$app->globals->getTraductor('713', Yii::$app->session['idiomaId'], 'vehiculoID'),'value' => 'idVehiculos.placa','format'=> 'raw'],
['attribute' => 'conductorID','label' => Yii::$app->globals->getTraductor('722', Yii::$app->session['idiomaId'], 'conductorID'),'value' => 'idConductores.nombre','format'=> 'raw'],
['attribute' => 'municipioID','label' => Yii::$app->globals->getTraductor('60', Yii::$app->session['idiomaId'], 'municipioID'),'value' => 'idMunicipios.nombreMunicipio','format'=> 'raw'],
['attribute' => 'fechaHoraAccidente','label' => Yii::$app->globals->getTraductor('723', Yii::$app->session['idiomaId'], 'fechaHoraAccidente'),'value' => 'fechaHoraAccidente','format'=> 'raw'],
['attribute' => 'descripcion','label' => Yii::$app->globals->getTraductor('476', Yii::$app->session['idiomaId'], 'descripcion'),'value' => 'descripcion','format'=> 'raw'],
['attribute' => 'latitud','label' => Yii::$app->globals->getTraductor('645', Yii::$app->session['idiomaId'], 'latitud'),'value' => 'latitud','format'=> 'raw'],
['attribute' => 'longitud','label' => Yii::$app->globals->getTraductor('644', Yii::$app->session['idiomaId'], 'longitud'),'value' => 'longitud','format'=> 'raw'],
							...
							'options' => ['style' => 'width:50px;'],
									...
									'buttons' => [
										'update' => function ($url, $model) {
											$url_group = 'index.php?r=accidentes/update&f='.$_GET['f'].'&id='.$model->accidenteID;
											return Html::a(
    ...
    function confirmDelete(id){
        alertify.confirm('<?= Yii::$app->globals->getTraductor(17, Yii::$app->session['idiomaId'], 'Confirmación') ?>', '¿<?= Yii::$app->globals->getTraductor(9, Yii::$app->session['idiomaId'], 'Seguro que desea eliminar el registro') ?>?', 
            function(){
                $.ajax({
                     type: 'POST',
                     url: "index.php?r=accidentes/delete",
                     data:{id:id},
