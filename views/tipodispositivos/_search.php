...
/* @var $model app\models\TipodispositivosSearch */
...
<div class="tipodispositivos-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='tipodispositivos'")->queryOne();
