...
/* @var $model app\models\ConexionesapisestablecimientosSearch */
...
<div class="conexionesapisestablecimientos-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='ConexionesApisEstablecimientos'")->queryOne();
