...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'conexionesapisestablecimientos', 'Conexionesapisestablecimientos', $frmSeguridad, 'update', '1', '&id='.$model->conexionApiEstablecimientoID);
