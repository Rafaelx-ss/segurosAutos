...
<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
	<li class="nav-item">
		<?php
		echo Html::a('<span><i class="'.$iSeacrh.'"></i> Consulta</span>', $url = ['acciones/index'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones()]);
		?>
    </li>
	<li class="nav-item">
		<?php
    ...
    <li class="nav-item">
		<?php
		echo  Html::a('<span><i class="'.$iDelete.'" aria-hidden="true"></i> Eliminar</span>', $url = ['acciones/deletedata&id='.$_GET['id']], $options = ['class' => 'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones()]);
		?>
    </li>
</ul>
