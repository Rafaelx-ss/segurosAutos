...
/* @var $model app\models\ContactosclientesSearch */
...
<div class="contactosclientes-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='ContactosClientes'")->queryOne();
