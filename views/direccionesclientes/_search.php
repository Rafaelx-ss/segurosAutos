...
/* @var $model app\models\DireccionesclientesSearch */
...
<div class="direccionesclientes-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='DireccionesClientes'")->queryOne();
