...
<div class="aplicaciones-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->aplicacionID], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->aplicacionID], [
