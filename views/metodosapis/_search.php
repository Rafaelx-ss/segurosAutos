...
/* @var $model app\models\MetodosapisSearch */
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='MetodosApis'")->queryOne();
