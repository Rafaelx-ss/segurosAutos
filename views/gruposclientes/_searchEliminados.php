...
/* @var $model app\models\GruposclientesSearch */
...
<div class="gruposclientes-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='GruposClientes'")->queryOne();
