...
/* @var $model app\models\Usuariosmigraciones */
	...
	if(isset($_GET['insert'])){
		if($_GET['insert'] == 'true'){
			echo '<div class="alert alert-success" role="alert">
					 <i class="fa fa-check-square-o" aria-hidden="true"></i>  '.Yii::$app->globals->getTraductor(8, Yii::$app->session['idiomaId'], 'Registro actualizado con exito').'</div>';
		}
	}
...
<?php 
$catalogo = Yii::$app->globals->getCatalogo('UsuariosMigraciones'); 
	...
	foreach($campos as $rCampos){
		if($rCampos['visible'] == 1){		
			if($rCampos['tipoControl'] == 'text' or $rCampos['tipoControl'] == 'number' or $rCampos['tipoControl'] == 'date' or $rCampos['tipoControl'] == 'email' or $rCampos['tipoControl'] == 'password' or $rCampos['tipoControl'] == 'color'){
				...
				if($rCampos['tipoControl'] == 'date'){$defaulValue = date('Y-m-d');}else{$defaulValue = $rCampos['valorDefault'];}
				if($rCampos['campoRequerido'] == 1){
					echo $form->field($model, $rCampos['nombreCampo'])->textInput(['value'=>$defaulValue, 'type'=>$rCampos['tipoControl'], 'required'=>'required', 'oninvalid'=>"InvalidMsg(this, 'Usuarios', '".$rCampos['tipoControl']."', '".$rCampos['nombreCampo']."');"])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				}else{
					echo $form->field($model, $rCampos['nombreCampo'])->textInput(['value'=>$defaulValue, 'type'=>$rCampos['tipoControl'], 'oninvalid'=>"InvalidMsg(this, 'Usuarios', '".$rCampos['tipoControl']."', '".$rCampos['nombreCampo']."');"])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				}
				...
				if($rCampos['tipoControl'] == 'date'){$defaulValue = date('Y-m-d');}else{$defaulValue = $rCampos['valorDefault'];}
				if($rCampos['campoRequerido'] == 1){
					echo $form->field($model, $rCampos['nombreCampo'])->textInput(['value'=>$defaulValue, 'type'=>'number', 'required'=>'required', 'step'=>'any', 'oninvalid'=>"InvalidMsg(this, 'Usuarios', '".$rCampos['tipoControl']."', '".$rCampos['nombreCampo']."');"])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				}else{
					echo $form->field($model, $rCampos['nombreCampo'])->textInput(['value'=>$defaulValue, 'type'=>'number', 'step'=>'any', 'oninvalid'=>"InvalidMsg(this, 'Usuarios', '".$rCampos['tipoControl']."', '".$rCampos['nombreCampo']."');"])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				}
				...
				if($rCampos['campoRequerido'] == 1){
					 echo $form->field($model, $rCampos['nombreCampo'])->widget(DateTimePicker::classname(), [
							'options' => ["autocomplete"=>"off", 'required'=>'required', 'value'=>date('Y/m/d H:i')],
							'pluginOptions' => [
								'autoclose'=>true,
					 ...
					 echo $form->field($model, $rCampos['nombreCampo'])->widget(DateTimePicker::classname(), [
							'options' => ["autocomplete"=>"off", 'value'=>date('Y/m/d H:i')],
							'pluginOptions' => [
								'autoclose'=>true,
								'format' => 'yyyy/mm/dd H:i',
								'todayHighlight' => true,
				...
				echo '<div class="col-4 float-left  pleft-0">';
					if($rCampos['valorDefault'] == '1'){
						echo $form->field($model, $rCampos['nombreCampo'])->checkbox(['checked'=>'checked', 'label' => Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo'])]);
					}else{
				...
				echo '<div class="col-4 float-left  pleft-0">';
					echo $form->field($model, $rCampos['nombreCampo'])->textarea(['value'=>$rCampos['valorDefault'], 'rows' => 4])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				echo '</div>';
				...
				echo $form->field($model, $rCampos['nombreCampo'],[
						...
						'pluginOptions' => [
							...
							'ajax' => [
								'url' => Url::to(['/usuariosmigraciones/getdatacombo']),
								'dataType' => 'json',
				...
				echo '<div class="col-sm-4 float-left pleft-0">
						<div class="form-group field-siniestros-d_detalle required has-success">
							...
							<select id="usuariosmigraciones-'.strtolower($rCampos['nombreCampo']).'" class="form-control" name="'.$catalogo['nombreModelo'].'['.$rCampos['nombreCampo'].']" required>
				...
				//no imprime el input
				echo '<div class="col-4 float-left  pleft-0">';
				echo $form->field($model, $rCampos['nombreCampo'])->textInput(['value'=>$rCampos['valorDefault'], 'readonly'=>'readonly'])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				echo '</div>';
			}else{
				echo '<div class="col-4 float-left  pleft-0">';
				echo $form->field($model, $rCampos['nombreCampo'])->textInput(['value'=>$rCampos['valorDefault'], 'oninvalid'=>"InvalidMsg(this, 'Usuarios', '".$rCampos['tipoControl']."', '".$rCampos['nombreCampo']."');"])->label(Yii::$app->globals->getTraductor(getNameInput($rCampos['textoID']), Yii::$app->session['idiomaId'], $rCampos['nombreCampo']));
				echo '</div>';
			}
		}else{
