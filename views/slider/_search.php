...
<div class="slider-search">
    ...
    <?= $form->field($model, 'configuracionesSliderID') ?>

    <?= $form->field($model, 'tituloSlider') ?>

    <?= $form->field($model, 'contenidoSlider') ?>

    <?= $form->field($model, 'imagenSlider') ?>

    <?= $form->field($model, 'ordenSlider') ?>

    <?php // echo $form->field($model, 'activoConfiguracionesSlider')->checkbox() ?>
