...
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'relacionpaquetessotfware', 'Relacionpaquetessotfware', $frmSeguridad, 'update', '1', '&id='.$model->relacionPaqueteSotfwareID);
