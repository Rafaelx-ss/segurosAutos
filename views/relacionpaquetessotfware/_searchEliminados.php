...
/* @var $model app\models\RelacionpaquetessotfwareSearch */
...
<div class="relacionpaquetessotfware-search">
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='RelacionPaquetesSotfware'")->queryOne();
