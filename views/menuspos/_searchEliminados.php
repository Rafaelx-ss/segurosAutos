...
/* @var $model app\models\MenusposSearch */
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='MenusPOS'")->queryOne();
