        ...
        <div class="page-title-actions">
			...
			foreach($iconAcciones as $rAccion){
				...
				if($rAccion['accionID'] == '7'){
					...
					echo Html::a('<i class="'.$iDelete.'" aria-hidden="true"></i> '.Yii::$app->globals->getTraductor(3, Yii::$app->session['idiomaId'], 'Eliminar'), $url = ['aformulariosperfiles/deletedata&id='.$_GET['id']], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn btn-outline-info']);
			?>
		</div>
     </div>
</div>
