...
<div class="app-page-title">
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
            ...
            <div>
				Aformulariosperfiles				<div class="page-title-subheading">Consulta</div>
            </div>
        </div>
        <div class="page-title-actions">
			...
			foreach($iconAcciones as $rAccion){
				...
				if($rAccion['accionID'] == '7'){
					...
					echo Html::a('<i class="'.$iSeacrh.'"></i> Consulta', $url = ['aformulariosperfiles/index'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn btn-outline-info']);
			
			
					echo Html::a('<i class="'.$iAdd.'" aria-hidden="true"></i> Alta', $url = ['aformulariosperfiles/create'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn btn-outline-info']);
...
<div class="main-card mb-3 card">
	...
	?>
					...
					'summary' => Html::a('<i class="fa fa-minus-square" aria-hidden="true"></i> Limpiar filtro', $url = ['aformulariosperfiles/index&clear=true'], $options = ['style'=>'color:#003e59;']).' | Viendo {count} de {totalCount} resultados.', 
					'filterModel' => $searchModel,       
					'columns' => [
						['class' => 'yii\grid\SerialColumn'],		  				
						['class' => 'yii\grid\CheckboxColumn', 'checkboxOptions' => function($data) {
										return ['value' => $data->permisoAccionID];
								},
						],
            'permisoAccionID',
            'permisoFormularioID',
							...
							'options' => ['style' => 'width:50px;'],
									...
									'buttons' => [
										'update' => function ($url, $model) {
											$url_group = 'index.php?r=aformulariosperfiles/update&id='.$model->permisoAccionID;
											return Html::a(
										...
										'delete' => function ($url, $model) {
											$url_group = 'javascript:confirmDelete('.$model->permisoAccionID.')';
											return Html::a(
    ...
    function confirmDelete(id){
        alertify.confirm('Confirmación', '¿Seguro que desea eliminar el registro?', 
            function(){
                $.ajax({
                     type: 'POST',
                     url: "index.php?r=aformulariosperfiles/delete",
                     data:{id:id},
