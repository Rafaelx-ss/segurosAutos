...
/* @var $model app\models\UsuariosapiSearch */
...
<?php  
$catalogo = Yii::$app->db->createCommand("SELECT * FROM Catalogos where regEstado='1' and nombreCatalogo='UsuariosAPI'")->queryOne();
...
?>
	...
	<div class="col-12 float-left  pleft-0">
        <?=  Html::submitButton(Yii::$app->globals->getTraductor(19, Yii::$app->session['idiomaId'], 'Buscar'), ['class' => 'btn btn-primary']) ?>
