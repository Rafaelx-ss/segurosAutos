...
<div class="app-page-title">
	<div class="page-title-wrapper">
    	<div class="page-title-heading">
            ...
            <div>
				Traducciones				<div class="page-title-subheading">Alta de registro</div>
            </div>
        </div>
        <div class="page-title-actions">
			...
			foreach($iconAcciones as $rAccion){
				...
				if($rAccion['accionID'] == '7'){
					...
					echo Html::a('<i class="'.$iSeacrh.'"></i> Consulta', $url = ['traducciones/index'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones()]);
			
					echo Html::a('<i class="'.$iAdd.'" aria-hidden="true"></i> Alta', $url = ['traducciones/create'], $options = ['class'=>'mb-2 mr-2 btn-pill btn-transition btn '.Yii::$app->globals->btnAcciones()]);
				?>
		</div>
     </div>
</div>
