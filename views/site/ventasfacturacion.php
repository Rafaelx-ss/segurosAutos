	...
	<div class="card-body">	
		...
		<div style="text-align: right;">
			...
			$form = ActiveForm::begin([
				'id' => 'login-form',
				'action' => ['site/ventasfacturacion&f='.$_GET['f']],
		...
		if(isset($_POST['FechaInicial']) and isset($_POST['FechaFinal'])  and isset($_POST['Siic'])){
			...
			echo "Ruta Sql:".$RutaApiSql."/api/ApiTokenSQLServer.php <br>";
			...
			echo "Ruta Mysql Envio: ".$RutaApiMysql."/api/ApiToken.php<br>";
			echo "usuario : ".$UsernameMysql;
			if($ptemp1 == ''){
				echo "pass ApiToken : Error en la contraseña<br>";
			}
				...
				try{
					if(ApiHttpClient::$Resultado){
						$TokenApiPaso2 = ApiHttpClient::$Token;
							...
							//echo ApiHttpClient::$Resultado;
						$mensaje .= "Token : Ocurrio un error ".ApiHttpClient::$Mensaje." ----> ";
						$errorData++;
					}
				}catch (Exception $e){
					$mensaje .= "Token : ".$this->mensaje = $e->getMessage()." ----> ";
					$errorData++;
				}
				//finaliza conexion api 2
				//echo "Ruta Sql:".$RutaApiSql." <br> Ruta Mysql Envio:".$RutaApiMysql."<br>";
						...
						if(ApiHttpClient::$EstatusHttp == 200){
							if(isset($arraydatos['resultado'])){
									...
									if($total_datos == 0){
										...
										$apiFactResp = ApiHttpClient::ConsumeApi('/api/ApiVentaFacturada.php','PUT',$parametrosMysql);
										...
										if(ApiHttpClient::$EstatusHttp == 200){
											...
											//$mensajePost .=  "Mensaje : ".$arrayApiFac['mensaje'].$mDesarrollo1;
											
											if(isset($arrayApiFac['mensaje'])){
												$mensajePost .=  "Mensaje : ".$arrayApiFac['mensaje'].$mDesarrollo;
											}else{
												$mensajePost .=  "Mensaje : ".$mDesarrollo;
											}
