...
$perElimckh = false;
$menuBotones = Yii::$app->globals->getActionButton($idForm, 'apis', 'Apis', $frmSeguridad, 'index', '1');

$perElimckh = $menuBotones['visible'];
echo $menuBotones['botones'];

if(Yii::$app->globals->getIndexSearch('Apis') != 0){
...
<div class="main-card mb-3 card">
	...
	?>
					...
					'summary' => Html::a('<i class="fa fa-minus-square" aria-hidden="true"></i> '.Yii::$app->globals->getTraductor(5, Yii::$app->session['idiomaId'], 'Limpiar filtros'), $url = ['apis/eliminados&f='.$idForm.'&clear=true'], $options = ['style'=>'color:#003e59;']).' | Viendo {count} de {totalCount} resultados.', 
					...
					'columns' => [
						...
						['attribute' => 'apiID','label' => Yii::$app->globals->getTraductor('89', Yii::$app->session['idiomaId'], 'apiID'),'value' => 'apiID','format'=> 'raw'],
['attribute' => 'nombreApi','label' => Yii::$app->globals->getTraductor('90', Yii::$app->session['idiomaId'], 'nombreApi'),'value' => 'nombreApi','format'=> 'raw'],
['attribute' => 'estadoApi','label' => Yii::$app->globals->getTraductor('34', Yii::$app->session['idiomaId'], 'estadoApi'),'value' => 'estadoApi','filter'=> [0=>'No',1=>'Si'],'format'=> 'boolean'],
['attribute' => 'rutaApi','label' => Yii::$app->globals->getTraductor('95', Yii::$app->session['idiomaId'], 'rutaApi'),'value' => 'rutaApi','format'=> 'raw'],
...
['attribute' => 'ordenMigracion','label' => Yii::$app->globals->getTraductor('191', Yii::$app->session['idiomaId'], 'ordenMigracion'),'value' => 'ordenMigracion','format'=> 'raw'],
['attribute' => 'tipoLista','label' => Yii::$app->globals->getTraductor('269', Yii::$app->session['idiomaId'], 'tipoLista'),'value' => 'tipoLista','format'=> 'raw'],
							...
							'options' => ['style' => 'width:50px;'],
									...
									'buttons' => [
										'update' => function ($url, $model) {
											$url_group = 'index.php?r=apis/update&f='.$_GET['f'].'&id='.$model->apiID;
											return Html::a(
