...
class Facturas extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['cotizacionID', 'establecimientoID', 'clienteID', 'metodoPagoID', 'formaPagoID', 'usoCfdiID', 'tipoRelacionID', 'numeroIntentosCancelacion', 'diasCredito', 'estatusPago', 'anio', 'mes', 'versionRegistro', 'regUsuarioUltimaModificacion', 'regFormularioUltimaModificacion', 'regVersionUltimaModificacion'], 'integer'],
            [['fechaFactura', 'fechaPago', 'fechaTimbrado', 'activoFactura', 'fechaSolicitudCancelacion', 'fechaCancelacion', 'regFechaUltimaModificacion'], 'safe'],
            ...
            [['direccionEmpresa', 'direccionCliente', 'url_factura', 'rutaPDF', 'rutaXML', 'urlAcuseCancelacion'], 'string', 'max' => 255],
            ...
            [['versionRegistro'], 'default', 'value' => 1],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ctaPago' => 'Cuenta de Pago',
            'urlAcuseCancelacion' => 'URL Acuse Cancelación',
            'versionRegistro' => 'Versión Registro',
