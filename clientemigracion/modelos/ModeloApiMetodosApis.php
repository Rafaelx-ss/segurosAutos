...
// constructor
	...
	function ObtenerDatos($id=0, $aplicacionID=0){
   		// $id = intval($id);
    	// query to check if email exists
    	echo $query = "select * from " . $this->NombreTabla . " where 1 " . ($aplicacionID > 0 ? " and apiID in(select apiID from Apis where aplicacionID in(2,3))" : "") . " " . ($id > 0 ? " and metodoApiID = ?" : "");
