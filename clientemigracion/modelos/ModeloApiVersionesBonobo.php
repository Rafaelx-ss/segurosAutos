		...
		foreach($registros as $item)
		 {
			//echo $item['textoID']."lolol";
			 if($this->ObtenerDatos($item['versionID'])){
				$this->Cambia($item['versionID'],$item['version'],$item['fechaLiberacionVersion'],$item['aliasVersion'],$item['urlVersion'],$item['urlDocumentacionVersion'],
				$item['versionActual'],$item['aplicacionID'],$item['versionRegistro'],$item['regEstado'],$item['regFechaUltimaModificacion'],$item['regUsuarioUltimaModificacion'],$item['regFormularioUltimaModificacion'],$item['regVersionUltimaModificacion']);
			}
			else{
				 if($coma)
				 {
...
function Cambia($versionID,$version,$fechaLiberacionVersion,$aliasVersion,$urlVersion,$urlDocumentacionVersion,$versionActual,$aplicacionID,$versionRegistro,$regEstado,$regFechaUltimaModificacion,$regUsuarioUltimaModificacion,$regFormularioUltimaModificacion,$regVersionUltimaModificacion){
    $query = "UPDATE " . $this->NombreTabla . " SET version=:version,fechaLiberacionVersion=:fechaLiberacionVersion,aliasVersion=:aliasVersion,urlVersion=:urlVersion,
	urlDocumentacionVersion=:urlDocumentacionVersion,versionActual=".$versionActual.",aplicacionID=:aplicacionID,versionRegistro=:versionRegistro,regEstado=:regEstado,regFechaUltimaModificacion=:regFechaUltimaModificacion,regUsuarioUltimaModificacion=:regUsuarioUltimaModificacion,regFormularioUltimaModificacion=:regFormularioUltimaModificacion,regVersionUltimaModificacion=:regVersionUltimaModificacion 
