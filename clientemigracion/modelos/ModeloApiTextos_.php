		...
		foreach($registros as $item)
		 {
			//echo $item['textoID']."lolol";
			 if($this->ObtenerDatos($item['textoID'])){
				$this->Cambia($item['textoID'],$item['tipoTexto'],$item['nombreTexto'],$item['activoTexto'],$item['versionRegistro'],$item['regEstado'],$item['regFechaUltimaModificacion'],$item['regUsuarioUltimaModificacion'],$item['regFormularioUltimaModificacion'],$item['regVersionUltimaModificacion']);
			}
			else{
				 if($coma)
				 {
				...
				$consulta= $consulta . $comaText . "('" . $item["textoID"] . "','" . $item["tipoTexto"] . "','" . $item["nombreTexto"] . "'," . $item["activoTexto"] . ",'" . $item["versionRegistro"] . "'," . $item["regEstado"] . ",'" . $item["regFechaUltimaModificacion"] . "','" . $item["regUsuarioUltimaModificacion"] . "','" . $item["regFormularioUltimaModificacion"] . "','" . $item["regVersionUltimaModificacion"] . "')";
			}
