...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ParidadSerial');
    $datoID=ApiTools::getParam('paridadID');
   	
	if($tabla->ObtenerDatos($datoID)){
...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ParidadSerial'); // abrir la tabla	
