...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ConfiguracionesConsola');
    $id=ApiTools::getParam('configuracionConsolaID');
...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ConfiguracionesConsola'); // abrir la tabla
