...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ConfiguracionBombasGenerales');
    $id=ApiTools::getParam('bombaNumero');
...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ConfiguracionBombasGenerales'); // abrir la tabla
