...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ImpresorasSpooler');
    $id=ApiTools::getParam('spoolerID');
	$impresorasid=ApiTools::getParam('impresoraID');
	$establecimientoID=ApiTools::getParam('establecimientoID');
    if( $tabla->ObtenerDatos($id,$impresorasid,$establecimientoID)){
...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ImpresorasSpooler'); // abrir la tabla
