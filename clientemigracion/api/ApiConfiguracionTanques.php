...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ConfiguracionTanques');
    $id=ApiTools::getParam('configuracionLecturasTanquesID');
...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ConfiguracionTanques'); // abrir la tabla
