...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ListadoApis');
    $aplicacionID=ApiTools::getParam('aplicacionID');
    $establecimientoID=ApiTools::getParam('establecimientoID');
	$grupoestablecimientoID=ApiTools::getParam('grupoestablecimientoID');
    	
	if( $tabla->ObtenerDatos($aplicacionID,$establecimientoID,$grupoestablecimientoID)){
