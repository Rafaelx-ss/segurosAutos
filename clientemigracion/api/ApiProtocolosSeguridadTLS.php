...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ProtocolosSeguridadTLS');
    $idData=ApiTools::getParam('protocoloSeguridadTSLID');
...
ApiTools::asignaMetodo(function() {
    $tabla = ApiTools::getModel('ProtocolosSeguridadTLS'); // abrir la tabla	
