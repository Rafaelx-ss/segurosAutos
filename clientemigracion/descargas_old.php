								...
								if(Yii::$app->session['TIPOMETODO']=="POST"){ 
									//try{
										...
										try{
											...
											$mensajeDesarrollo .= "<br>Error de datos Insertados : ".$e->getMessage()."<br>";
										}
									...
									try{	
										...
										if(count($datosInsertados2)>0){
											...
											foreach($datosInsertados2 as $item4){
												...
												if($objeto=="ConfiguracionCompras" or $objeto=="ConfiguracionCompras"){
													$parametrosR = json_encode(Array(
														"Token" => ApiHttpClient::$Token,
												...
												if($objeto=="ConfiguracionReclasificacion"){
													$parametrosR = json_encode(Array(
														"Token" => ApiHttpClient::$Token,
												...
												if($objeto=="configuracionfacturacion"){
													$parametrosR = json_encode(Array(
														"Token" => ApiHttpClient::$Token,
												...
												if($objeto=="ConfiguracionLiquidacion"){
													$parametrosR = json_encode(Array(
														...
														"activiaTiempoLiquidacion" => $item4['activiaTiempoLiquidacion'],
												...
												if($objeto=="ConfiguracionCompras"){
													$parametrosR = json_encode(Array(
														"Token" => ApiHttpClient::$Token,
														"configuracionCompraID" => $item4['configuracionCompraID'],
														"validaFolioAlfaNumerico" => $item4['validaFolioAlfaNumerico'],
												...
												if($objeto=="ConfiguracionLiquidacion"){
													$parametrosR = json_encode(Array(
														...
														"tolerancialiquidacion" => $item4['tolerancialiquidacion'],
														"verDescripcionJornada" => $item4['verDescripcionJornada'],
														"resumenConImpuestos" => $item4['resumenConImpuestos'],
														"establecimientoID" => $item4['establecimientoID'],
														"versionRegistro" => $item4['versionRegistro'],
														"regEstado" => $item4['regEstado'],
														"regFechaUltimaModificacion" => $item4['regFechaUltimaModificacion'],
											...
											$mensajeUser .= "La consulta local no trajo resultados ".$migracion."<br>";
										}
										if($validaEjecucion){
											$colorEvento = "verde";
										...
										$mensajeCorto = "No hay registros para enviar";
										$mensajeUser = "Error al consultar datos locales, SIN registros  para enviar a método POST<br>";
										$mensajeDesarrollo .= "Error al consultar datos locales, SIN registros  para enviar a método POST: <br />".$e->getMessage()."<br>";
										print_r($mensajeDesarrollo);
